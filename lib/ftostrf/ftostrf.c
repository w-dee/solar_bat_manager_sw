...
// Make-shift version of dtostrf, but only use float instead of double.
// Double-precision functions of STM32 *exists*, but too large to fit 32k flash.
// This version of dtostrf (and float_to_string() ) only use single-precision
// computation.


#define double float

char *ftostrf(double val, signed char width, unsigned char prec, char *sout)
{
